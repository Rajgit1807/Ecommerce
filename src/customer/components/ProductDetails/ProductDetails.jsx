    ...
    return (
        <div className="bg-white lg:px-20">
            <div className="pt-6">
                ...
                <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-1 px-4 pt-10'>
                    {/* Image gallery */}
                    <div className="flex flex-col items-center max-h-[40rem] shadow-xl">
                        <div className="overflow-hidden rounded-lg max-w-[30rem] max-h-[35rem]">
                            <img
                                alt={products.product?.category.name}
                    ...
                    {/* Product info */}
                    <div className="mx-auto lg:col-span-1 max-w-2xl px-4 pb-16 sm:px-6 lg:max-2-7xl lg:px-8 lg:pb-24">
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <div className="mt-5">
                                <div className='flex items-center space-x-3'>
                                    ...
                                    <p className='opacity-50 text-sm'>233234 Ratings</p>
                                    <p className='ml-3 te3x-sm font-medium text-indigo-600 hover:text-indigo-500'>3344 Reviews</p>
                                </div>
                            </div>
                            ...
                            <form className="mt-10">
                                ...
                                <Button onClick={handleAddToCart} variant='contained' sx={{ px: "1.5rem", py: '0.7rem', bgcolor: "#9155fd" }}
                                >
                                    Add to Cart
                                </Button>
                            </form>
                    ...
                    <div className='border p-5'>
                        <Grid container spacing={7}>
                            ...
                            <Grid item xs={5}>
                                ...
                                <div className="flex items-center space-x-3">
                                    <Rating value={4.6} precision={.5} readOnly /> <p className="opacity-60">54890 Ratings</p>
                                </div>
                                <Box className="mt-4 space-y-3">
                                    <Grid container alignItems="center" gap={2}>
                                        ...
                                        <Grid item xs={7}>
                                            <LinearProgress
                                                sx={{ bgcolor: "#dedede", borderRadius: 4, height: 7 }}
                                                variant="determinate"
                                                value={40}
                                                color="success"
                                            />
